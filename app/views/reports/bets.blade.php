                            ...
                            <table id="dt_basic" class="table table-striped table-bordered" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-fw fa-money txt-color-blue hidden-md hidden-sm hidden-xs"></i> Bet</th>
                                        <th>Conversion</th>
                                        <th>Points Added</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td><i class="fa fa-fw fa-usd text-muted hidden-md hidden-sm hidden-xs"></i> {{ $row->bet }}</td>
                                        <td>{{ $row->points_conversation }}</td>
                                        <td>{{ $row->points_converted }}</td>
